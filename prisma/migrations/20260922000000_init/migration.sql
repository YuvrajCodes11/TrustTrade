...
-- CreateEnum
CREATE TYPE "ListingStatus" AS ENUM ('ACTIVE', 'PENDING_DEPOSIT', 'IN_ESCROW', 'SOLD', 'CANCELLED');

-- CreateEnum
CREATE TYPE "TransactionStatus" AS ENUM ('ACTIVE', 'COMPLETED', 'DISPUTED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "DisputeStatus" AS ENUM ('OPEN', 'UNDER_REVIEW', 'RESOLVED_REFUND', 'RESOLVED_RELEASE', 'DISMISSED');
...
CREATE TABLE "ScamRule" (
    ...
    CONSTRAINT "ScamRule_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Conversation_listingId_buyerId_idx" ON "Conversation"("listingId", "buyerId");
...
-- CreateIndex
CREATE INDEX "Transaction_listingId_buyerId_idx" ON "Transaction"("listingId", "buyerId");

-- CreateIndex
CREATE INDEX "Dispute_transactionId_idx" ON "Dispute"("transactionId");

-- CreateIndex
CREATE INDEX "Review_transactionId_reviewerId_idx" ON "Review"("transactionId", "reviewerId");
...
-- AddForeignKey
ALTER TABLE "AdminRole" ADD CONSTRAINT "AdminRole_grantedBy_fkey" FOREIGN KEY ("grantedBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Report" ADD CONSTRAINT "Report_relatedConversationId_fkey" FOREIGN KEY ("relatedConversationId") REFERENCES "Conversation"("id") ON DELETE SET NULL ON UPDATE CASCADE;
